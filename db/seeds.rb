...
exercises = [
  ...
  {name: "T-bar Rear Deltoid Row", difficulty: intermediate, instructions: "Stand on platform, lever between legs. Bend over with back straight and grasp handles with wide overhand grip. Pull lever up, with upper arms perpendicular to torso, until elbows pass shoulders. Bring shoulder blades together. Return, keep arms slightly flexed, repeat.", focus: strength, weighted: true, setted: true},
  {name: "Smith Machine Rear Deltoid Row", difficulty: intermediate, instructions: "Start off standing with your feet shoulder-width apart, keeping your knees bend and good posture. Slowly bend forward at your waist until your chest is parallel with the floor. Grab the bar with an overhand grip, making sure that you keep your chest still and pull the bar up as high as possible. Hold briefly then lower the the starting position in a controlled manner. Once you reach the top position, hold for a count and squeeze your back muscles, then return back to the starting position.", focus: strength, weighted: true, setted: true},
  {name: "Stair Push-up", difficulty: beginner, instructions: "On a set of stairs, walk your hands closer than shoulder width and stay on your toes. Keep your body straight and lower your chest towards the stairs. Push yourself back up and repeat.", focus: str_cardio, setted: true},
  ...
  {name: "Kettlebell Press-out", difficulty: advanced, instructions: "Start with the kettlebell in the rack position (the end position of a clean). Make sure your elbow is tucked in to your chest, then press the weight directly up overhead. Lower the weight by reversing the bell path and repeat the move.", focus: strength, weighted: true, setted: true},
  {name: "Suspension Trainer Hamstring Curl", difficulty: intermediate, instructions: "Raise legs and place heels in loops with soles contacting handles. Extend legs out and place arms on floor off to sides. Straighten lower back, knees, and hips, raising back and hips off of floor. Pull heels toward rear end by bending knees and hips simultaneously.", focus: strength, setted: true},
  {name: "Overhead Barbell Lunge", difficulty: advanced, instructions: "Perform the overhead lunge (non-walking) as follows: Hold a plate, weighted bar, kettlebell or dumbbell overhead with your feet shoulder-width apart and knees slightly bent. Maintain the weight in a position in the same vertical plane as the shoulder joint(s). With one leg, step forward into a deep lunge position.", focus: strength, weighted: true, setted: true},
  {name: "Walking Barbell Lunge", difficulty: advanced, instructions: "Standing tall with your feet shoulder-width apart, hold a barbell across your shoulder blades. Take a large step forward with one leg and drop your hips into a lunge, bending both knees to 90 degrees. Keep your chest up and your shoulders back. Step forward with your back leg to bring your feet together.", focus: strength, weighted: true, setted: true},
  {name: "Inchworm", difficulty: beginner, instructions: "Start standing, reach your arms down toward the ground, walk your hands away from your feet, entering a plank-like position, before stepping your feet forward toward your hands and finally returning to a standing position.", focus: str_cardio, setted: true},
  {name: "Power Skip", difficulty: beginner, instructions: "Start standing with your feet hip distance apart. Lift your right knee and spring up off your left foot, hopping into the air. Switch. Continue in a “skipping” motion in place for desired amount of time.", focus: cardio, setted: true},
