...
exercises = [
    ...
    {name: 'Handstand Push-up', difficulty: advanced, instructions: "Face a wall in a standing position. Kick your feet up so you’re in a handstand position against a wall. Squeeze your abs, glutes and thigh muscles. Lower yourself toward the ground as far as possible. Push back up and repeat.", focus: str_cardio},
    ...
    {name: "Stair Push-up", difficulty: beginner, instructions: "On a set of stairs, walk your hands closer than shoulder width and stay on your toes. Keep your body straight and lower your chest towards the stairs. Push yourself back up and repeat.", focus: str_cardio},
    ...
    {name: "Lying Preacher Curl", difficulty: intermediate, instructions: "Exhale as you curl the barbell upwards, towards your shoulders. Hold for a count of two and squeeze your biceps. Inhale as you lower the barbell until your elbows are fully extended.", focus: strength},
    ...
    {name: "Bodyweight Walking Lunge", difficulty: beginner, instructions: "Stand up straight with your feet shoulder-width apart. Step forward with your right leg, putting the weight into your heel. Bend the right knee, lowering down so that it's parallel to the floor in a lunge position.", focus: str_cardio},
    ...
    {name: "Jab", difficulty: beginner, instructions: "Simultaneously pull your arms down so that your elbows are bent by your ribs with weights at chin-height and kick with your right leg, pointing your toes at the top and using your hips for power. Return to start and repeat on the right.", focus: cardio},
